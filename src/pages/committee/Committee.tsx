          ...
          <div key={index} className="mb-14 flex gap-4 flex-col items-center">
            ...
            <div className="flex flex-wrap gap-6">
              {mem?.members?.map((person, id) => (
                <div
                  key={id}
                  className="group  transition-[filter] relative w-[250px] h-[350px] bg-[#FAEDE4] font-['Roboto_Flex'] border-b-2 border-b-[#F04E29] flex flex-col items-center  overflow-visible "
                >
                  <img
